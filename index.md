...
- **Display name** — used to identify you to friends and activity participants
...
- All data is stored securely using **Google Firebase** (Firebase Authentication and Cloud Firestore)
- Data is transmitted over encrypted HTTPS connections
- We do not store passwords directly — authentication is handled securely by Firebase Authentication
...
- Your display name and activity progress are visible only to users you have added as friends or are participating in shared activities with

## In-App Purchases

Wirdi offers optional in-app purchases:
...
Wirdi is not directed at children under the age of 13. We do not knowingly collect personal information from children under 13. If you believe a child under 13 has provided us with personal information, please contact us so we can take appropriate action.
